...
AXON is a **workspace** you open in a code editor, plus an **AI assistant** that
...
## The one idea that makes AXON work
...
AXON keeps the **knowledge** safe and organized, and lets the AI **generate the
...
- [ ] I understand AXON is a workspace + an AI assistant, not a program I run.
