...
You rarely need these to use AXON, but here they are whenever a word is unfamiliar.
...
| **Repository (repo)** | A folder of files that also keeps its full history. This whole AXON folder is a repository. |
...
| **Terminal** | A text box where you type commands. In AXON the AI uses it; you rarely do. |
...
| **Prompt** | A message you send the AI. In AXON, just plain English describing what you want. |
...
| **Phase / Step** | One of the 12 stages of the AXON workflow. |
