...
You rarely need these to use AutoPCB, but here they are whenever a word is unfamiliar.
...
| **Repository (repo)** | A folder of files that also keeps its full history. This whole AutoPCB folder is a repository. |
...
| **Terminal** | A text box where you type commands. In AutoPCB the AI uses it; you rarely do. |
...
| **Prompt** | A message you send the AI. In AutoPCB, just plain English describing what you want. |
...
| **Phase / Step** | One of the 12 stages of the AutoPCB workflow. |
